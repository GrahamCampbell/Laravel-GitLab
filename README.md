...
Laravel GitLab requires [PHP](https://php.net) 7.1-7.4. This particular version supports Laravel 5.5-7.
...
| 2.7    | :x:                | :x:                | :x:                | :x:                | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: |
...
```bash
$ composer require graham-campbell/gitlab:^2.7 php-http/guzzle6-adapter:^2.0
```
