...
| 5.3    | :x:                | :x:                | :x:                | :x:                | :x:                | :x:                | :x:                | :x:                | :white_check_mark: | :white_check_mark: | :white_check_mark: |
...
```bash
$ composer require "graham-campbell/gitlab:^5.3" "guzzlehttp/guzzle:^7.2" "http-interop/http-factory-guzzle:^1.0"
```
...
For more information on how to use the `Gitlab\Client` class we are calling behind the scenes here, check out the docs at https://github.com/GitLabPHP/Client/tree/11.3.0#general-api-usage, and the manager class at https://github.com/GrahamCampbell/Laravel-Manager#usage.
