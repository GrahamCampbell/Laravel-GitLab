 ...
 * @method \Gitlab\Api\GroupsHooks                        groupsHooks()
 * @method \Gitlab\Api\GroupsMilestones                   groupsMilestones()
 * @method \Gitlab\Api\Integrations                       integrations()
 * @method \Gitlab\Api\IssueBoards                        issueBoards()
 * @method \Gitlab\Api\IssueLinks                         issueLinks()
 * @method \Gitlab\Api\Issues                             issues()
 * @method \Gitlab\Api\ResourceIterationEvents            resourceIterationEvents()
 * @method \Gitlab\Api\ResourceLabelEvents                resourceLabelEvents()
 * @method \Gitlab\Api\ResourceMilestoneEvents            resourceMilestoneEvents()
 * @method \Gitlab\Api\ResourceStateEvents                resourceStateEvents()
 * @method \Gitlab\Api\ResourceWeightEvents               resourceWeightEvents()
 ...
 * @method \Gitlab\Api\PersonalAccessTokens               personalAccessTokens()
 * @method \Gitlab\Api\ProjectNamespaces                  namespaces()
 * @method \Gitlab\Api\Projects                           projects()
 * @method \Gitlab\Api\Registry                           registry()
 ...
 * @method \Psr\Http\Message\StreamFactoryInterface       getStreamFactory()
 *
